...
class DualBranchModel(nn.Module):
    ...
    NIFEA-specific: Handles 4-channel ECG input
    """
    ...
    def __init__(self,
        ...
        Args:
            in_channels: Number of input channels (4 for NIFEA ECG)
            window_size: Length of input window
        ...
        # NIFEA-specific: Adjust feature dimensions for 4-channel input
        self.cnn_branch = self._build_cnn_branch(in_channels, window_size, use_residual)

        # Combined classification layer with dropout
        self.fc_input_dim = 128 + num_prototypes  # 128 from CNN + num_prototypes from shapelets
    ...
    def _build_cnn_branch(self, in_channels: int, window_size: int,
        ...
        if use_residual:
            ...
            return nn.Sequential(
                ...
                # Additional conv for NIFEA's 4-channel input
            ...
            return nn.Sequential(
                ...
                # Layer 4 (NIFEA-specific: more channels for 4-channel input)
                nn.Conv1d(64, 128, kernel_size=3, padding=1),
                nn.BatchNorm1d(128),
                nn.ReLU(),
                nn.Dropout(self.dropout_rate),
...
class LightweightDualBranchModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.fc_input_dim = 64 + num_prototypes
        self.fc = nn.Sequential(
            nn.Dropout(dropout_rate * 0.5),
