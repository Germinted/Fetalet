"""Training and evaluation functions for NIFEA Fetal Heart Rate Analysis"""
...
class Trainer:
    """
    Trainer class for the dual-branch NIFEA model.
    """
...
def initialize_prototypes(model: nn.Module,
    ...
    # Collect abnormal samples (arrhythmia)
    abnormal_samples = []
    all_samples = []
